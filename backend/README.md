...
## Project Structure
    ...
    ├── tst_daniel_final_op_22935  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_final_op_22935`
...
2. Clone this repo and `cd tst_daniel_final_op_22935`
